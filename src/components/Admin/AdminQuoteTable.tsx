        ...
        <div className="flex items-center gap-2 w-full lg:w-auto flex-wrap">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem onClick={() => setEventTypeFilter("wedding")}>
                Wedding
              </DropdownMenuItem>
              <DropdownMenuItem onClick={() => setEventTypeFilter("corporate")}>
                Corporate
              </DropdownMenuItem>
              <DropdownMenuItem onClick={() => setEventTypeFilter("birthday")}>
                Birthday
              </DropdownMenuItem>
              <DropdownMenuItem
              ...
              <DropdownMenuItem onClick={() => setEventTypeFilter("private")}>
                Private Party
              </DropdownMenuItem>
              <DropdownMenuItem onClick={() => setEventTypeFilter("other")}>
                Other
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
                  ...
                  <TableCell className="text-right">
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuItem
                          onClick={() => handleStatusUpdate(quote._id, "New")}
                        >
                          Mark as New
                        </DropdownMenuItem>
                        <DropdownMenuItem
                          onClick={() =>
                            handleStatusUpdate(quote._id, "Pending")
                          }
                        >
                          Mark as Pending
                        </DropdownMenuItem>
                        <DropdownMenuItem
                          onClick={() =>
                            handleStatusUpdate(quote._id, "Resolved")
                          }
                        >
                          Mark as Resolved
                        </DropdownMenuItem>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Badge
                    className={`mt-1 ${getEventTypeColor(
                      viewQuote.eventType
                    )} border`}
                  >
                    {viewQuote.eventType}
                ...
                <div>
                  ...
                  <p className="text-slate-900">
                    {format(new Date(viewQuote.eventDate), "MMMM d, yyyy")}
                  </p>
                </div>
                <div>
                  <label className="text-sm font-medium text-slate-600">
                ...
                {viewQuote.budget && (
                  <div className="col-span-2">
                    ...
                    <p className="text-slate-900">
                      {getBudgetDisplay(viewQuote.budget)}
                    </p>
                  </div>
                )}
                ...
                <div>
                  ...
                  <span
                    className={`inline-block text-xs font-medium px-2 py-1 rounded-full border mt-1 ${getPriorityColor(
                      viewQuote.priority
                    )}`}
                  >
                    {viewQuote.priority.charAt(0).toUpperCase() +
                      viewQuote.priority.slice(1)}
                  </span>
                </div>
                <div>
                  <label className="text-sm font-medium text-slate-600">
            ...
            <form
              onSubmit={async (e) => {
                ...
                const updateData = {
                  ...
                  requirements:
                    (formData.get("requirements") as string) || undefined,
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                ...
                <div>
                  ...
                  <Input
                    name="eventDate"
                    type="date"
                    defaultValue={editQuote.eventDate.split("T")[0]}
                    required
                  />
                </div>
                <div>
                  ...
                  <Input
                    name="guestCount"
                    defaultValue={editQuote.guestCount}
                    required
                  />
                </div>
                <div className="col-span-2">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
            ...
            <p className="text-slate-600 mb-6">
              ...
              <strong>{deleteQuote.name}</strong>? This action cannot be undone.
            </p>
            <div className="flex justify-end gap-2">
