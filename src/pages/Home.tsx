...
import { ChefHat, Users, Sparkles, Award, ArrowRight, Star, Clock, Heart, Camera, UtensilsCrossed, Trophy, BookOpen } from "lucide-react";
...
const Home = () => {
  ...
  const heroSlides = [
    {
      ...
      description: "From intimate gatherings to grand celebrations, we create unforgettable moments with exceptional cuisine and impeccable service.",
      ctaPrimary: { text: "Get a Quote", link: "/quote", variant: "hero" as const },
      ctaSecondary: { text: "View Menu", link: "/menu", variant: "outline" as const },
    ...
    },
    {
      ...
      description: "Our team of award-winning chefs brings years of experience and culinary innovation to create extraordinary dining experiences that exceed expectations.",
      ctaPrimary: { text: "Meet Our Chefs", link: "/about", variant: "hero" as const },
      ctaSecondary: { text: "View Services", link: "/services", variant: "outline" as const },
    ...
    },
    {
      ...
      description: "Transform your wedding into an extraordinary celebration with our bespoke catering services, elegant presentations, and personalized menu creations.",
      ctaPrimary: { text: "Wedding Packages", link: "/services", variant: "hero" as const },
      ctaSecondary: { text: "View Gallery", link: "/gallery", variant: "outline" as const },
  ...
  const features = [
    {
      icon: ChefHat,
      title: "Expert Chefs",
      description: "Our team of award-winning chefs brings culinary excellence to every event",
    },
    {
      icon: Users,
      title: "Personalized Service",
      description: "Tailored menus and dedicated event coordinators for your special day",
    },
    {
      icon: Sparkles,
      title: "Premium Quality",
      description: "Only the finest ingredients and impeccable presentation standards",
    },
    {
      icon: Award,
  ...
  const services = [
    { title: "Wedding Catering", description: "Make your special day unforgettable" },
    { title: "Corporate Events", description: "Professional service for business gatherings" },
    { title: "Private Parties", description: "Intimate celebrations with exquisite cuisine" },
  ];

  const menuHighlights = [
    {
      title: "Signature appetizers",
      description: "Handcrafted starters that set the tone for an extraordinary dining experience",
      price: "₹800-₹1,200",
    },
    {
      title: "Gourmet main courses",
      description: "Expertly prepared entrees featuring premium ingredients and innovative techniques",
      price: "₹1,500-₹2,500",
    },
    {
  ...
  const galleryImages = [
    { src: heroImage, title: "Elegant Dinner Setup", category: "Corporate Events" },
  ...
  const blogPosts = [
    {
      ...
      excerpt: "Discover the latest trends in wedding catering, from interactive food stations to sustainable menu options...",
      date: "Dec 15, 2024",
      readTime: "5 min read",
    },
    {
      title: "Corporate Event Catering: Creating Professional Impressions",
      excerpt: "Learn how to elevate your corporate events with sophisticated catering that impresses clients and colleagues...",
      date: "Dec 10, 2024",
      readTime: "4 min read",
    },
    {
      title: "Seasonal Menu Planning: Winter Delights",
      excerpt: "Explore our seasonal winter menu featuring warming spices, comfort foods, and innovative seasonal ingredients...",
      date: "Dec 5, 2024",
      readTime: "6 min read",
    },
  ];
  ...
  const awards = [
    ...
    { title: "Excellence in Wedding Catering", organization: "Indian Wedding Awards" },
    { title: "Sustainable Food Practices", organization: "Green Chef Initiative" },
    { title: "Customer Choice Award", organization: "Event Planning Excellence" },
  ];
                    ...
                    <div className="max-w-4xl mx-auto">
                      ...
                      <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in" style={{ animationDelay: "0.8s" }}>
                        <Link to={slide.ctaPrimary.link}>
                          <Button variant={slide.ctaPrimary.variant} size="lg" className="group">
        ...
        <div className="container mx-auto px-6 lg:px-12">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              We combine culinary excellence with exceptional service to create memorable experiences
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <Card key={index} className="p-8 text-center hover:scale-105 transition-smooth card-shadow">
        ...
        <div className="container mx-auto px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <Card key={index} className="p-10 hover:scale-105 transition-smooth card-shadow">
                <h3 className="text-2xl font-semibold mb-3">{service.title}</h3>
                <p className="text-muted-foreground mb-6 leading-relaxed">{service.description}</p>
                <Link to="/services" className="text-accent font-medium inline-flex items-center gap-2 hover:gap-3 transition-smooth">
                  Learn More
        ...
        <div className="container mx-auto px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {galleryImages.map((image, index) => (
              <div key={index} className="relative group overflow-hidden rounded-lg card-shadow">
                <img
                  src={image.src}
                  alt={image.title}
      ...
      <section className="py-24 bg-muted">
        <div className="container mx-auto px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              { step: "01", title: "Initial Consultation", desc: "Share your vision and requirements with our team" },
              { step: "02", title: "Custom Proposal", desc: "Receive a tailored menu and service plan" },
              { step: "03", title: "Tasting & Refinement", desc: "Sample dishes and perfect every detail" },
              { step: "04", title: "Event Execution", desc: "Sit back while we deliver excellence" },
            ].map((item, index) => (
      ...
      <section className="py-24 bg-background">
        <div className="container mx-auto px-6 lg:px-12">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Passionate chefs and culinary experts dedicated to creating exceptional experiences
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="container mx-auto px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {blogPosts.map((post, index) => (
              <Card key={index} className="p-6 hover:scale-105 transition-smooth card-shadow">
                ...
                <Link to="/blog" className="text-accent font-medium inline-flex items-center gap-2 hover:gap-3 transition-smooth">
                  Read More
                  <ArrowRight className="h-4 w-4" />
                </Link>
              </Card>
      ...
      <section className="py-24 hero-gradient text-primary-foreground">
        <div className="container mx-auto px-6 lg:px-12 text-center">
          ...
          <p className="text-lg mb-10 max-w-2xl mx-auto opacity-95">
            Let's discuss your event and create a customized menu that exceeds your expectations
          </p>
